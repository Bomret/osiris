...
define(["amplify", "utils", "webgl", "loadObjModel", "loadShaders", "renderScene", "rendering", "scene", "glmatrix"],
    function(amplify, utils, webgl, loadObjModel, loadShaders, renderScene, rendering, scene, glmatrix) {
        "use strict";
        ...
        return {
            init: function(specification) {
                ...
                function handleKeyDown(event) {
                    if (event.keyCode === 37) {
                        // left arrow
                        _cubeRotationNode.angle += 5;
                    }
                }

                _socket = new WebSocket("@routes.Application.socket");
