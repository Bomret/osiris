...
/**
 * Contains methods to read the content of text files from specified locations.
 *
 * User: Stefan Reichel
 * Date: 25.07.12
 * Time: 00:23
...
object ReadTextFile {
   ...
   * This method does not do any error handling, so if any exceptions are thrown on the inside they will get through.
   *
